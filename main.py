...
def send_text() :
    ...
    account_sid = 'AC0b4d28bd38c5c436dea458e5dd1e2c3f'
    auth_token = 'bd9f9c9ddbc034a7b0067b27ca6438ac'
...
#    url = "https://api.twilio.com/2010-04-01/Accounts/"+ twilio_account_id +"/Messages.json"
#    text="Thank you for shopping with us! Here's your bill: "
#    for i in range(len(curr_name)):
#        text+=str(curr_name[i])+" Rs."+str(curr_amount[i])+", "
#    
...
#    payload='From=whatsapp%3A%2B14155238886&Body='+text+'&To=whatsapp%3A%2B91'+curr_phone[0]
#    headers = {'Authorization': 'Basic QUMwNjI1M2E4NGQ2MmMxMmUxNDM1MDk5YTdmMDAzYzcyNjpiOWJlMGNjYzNlZDQ5YjAwYzQwN2YwODU2NDRmNGExMQ==',
